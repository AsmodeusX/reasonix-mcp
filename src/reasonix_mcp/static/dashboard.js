const state = { password: "", fleet: null, routines: [], templates: [], selected: null, selectedRoutine: null, detail: null, refreshTimer: null, collapsedOwners: new Set(), originalConfig: {}, timelineSession: null };
